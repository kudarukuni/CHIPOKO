      ...
      <Container>
        <VStack spacing={8}>
          ...
          <Text color="bodyText" fontSize="xl" textAlign="center">
            Each Reaper NFT is randomly generated by the candy machine and can be staked to receive
            <Text as="b"> $GSC</Text>. Use your <Text as="b"> $GSC</Text> to
