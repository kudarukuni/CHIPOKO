...
const Connected: FC = () => {
  ...
  return (
    <VStack spacing={10} zIndex={20}>
      <Container>
        <VStack spacing={8}>
          ...
          <Text color="bodyText" fontSize="xl" textAlign="center">
            Each Chipoko NFT is randomly generated by the candy machine and can be staked to receive
            <Text as="b"> $GRC</Text>. Use your <Text as="b"> $GRC</Text> to
      ...
      <Button bgColor="#0000BB" color="white" maxW="380px" onClick={handleClick} isLoading={isMinting} _hover={{ bgColor: "#0000FF" }}>
        <Text>Mint A Ghost</Text>
      </Button>
    </VStack>
  )
}
