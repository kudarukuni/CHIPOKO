...
const tokenSymbol = "GSC";
const tokenDescription = "A Token For Grim Reapers";
const tokenImageFileName = "ghostcoin.png";
const tokenImagePath = `tokens/bld/assets/${tokenImageFileName}`;
...
async function main() {
  ...
  await createBldToken(
    connection,
    payer,
    new web3.PublicKey("EMiC3cMuPLcaRDtVFVnxQKeRLKHLSgusW2bRdWcCFLrc")
  )
}
